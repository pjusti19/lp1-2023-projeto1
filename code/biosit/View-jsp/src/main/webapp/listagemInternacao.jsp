   ...
   --%>
    <%@page contentType="text/html" pageEncoding="UTF-8"%>
        <%@page import="java.util.ArrayList"%>
            <%@page import="br.cefetmg.biosit.dto.Internacao"%>
                <% ArrayList<Internacao> lista = (ArrayList<Internacao>)
                        ...
                        <%@include file="header.jsp" %>
                            ...
                            <div id="myModal">
                                ...
                                <select id="esp" name="urg" style="margin-top: 6%; width: 100%; ">>
                                    ...
                                    <option value="Baixa" <%= "Baixo".equals(urgmodal) ? "selected" : "" %>> Baixa</option>
...
for(int i = 0; i <lista.size(); i++) {%>
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center;">
                                                            <%=lista.get(i).getLeito()%>
                                                        </td>
                                                        <td style="text-align: center;">
                                                            <%=lista.get(i).getDat_ent()%>
                                                        </td>
                                                       
                                                        <td style="padding:0.5%; background-color: white;">
                                                            <a href="editarinternacao?idinter=<%=lista.get(i).getIdinter()%>" class="botao"><img src="imgs/editar.png" id="icone"> </a>
                                                            <a href="apagarinternacao?idinter=<%=lista.get(i).getIdinter()%>" class="botao"><img src="imgs/lixeira.png" id="icone"> </a>
                                                        </td>
                                                    </tr>
                                                    <% } %>
                                        ...
                                        <a href="novaInternacao.jsp" class="botaotriagem"><button type="button" style="border: none;
    background-color: var(--azul);
    height: 50px;
    width: 49%">Nova Internação</button></a>
                                        <a href="novainternacao.jsp" class="botaotriagem" style="background-color: white;"><button type="button" style="border: none;
    background-color: var(--azul);
    height: 50px;
